	...
	<div class="ordering" v-loading.fullscreen.lock="loading">
		...
		<div class="content-view">
			...
			<div v-if="nodatas">
				...
				<div>{{goods_item.specsArray[0].unitprice}}</div><!--specsArray中取 -->
			  <div>
				  <el-button size="small" @click="edIt(goods_item)">编辑</el-button>
	...
	methods:{
		...
		async obtaindishes(){
			try{
				...
				// console.log(JSON.parse(this.tabcont[0].specsArray))
